...
CREATE TABLE acc_criteria (
 ...
 sourceipaddresses       character varying(256),
 destinationipaddresses  character varying(256),
 protocol                character varying(3)  CONSTRAINT chck_protocol CHECK (protocol = 'tcp' OR protocol = 'udp' OR protocol = 'any'),
 sourceports             character varying(128),
 destinationports        character varying(128),
 dscp                    character varying(16),
 multicast               boolean,
 rate_sh                 real                  not null,
 rate_wh                 real                  not null,
...
ico 		character varying(16)  	not null,
dic 		character varying(16) 	not null,
accountno 	character varying(16) 	not null,
tax 		character varying(2) 	not null
);

CREATE INDEX ix_datetime ON acc_record (datetime);

insert into ACC_USER values (1,'Matus Husovsky','CNL','Letna 9','23321','0092', 'matus.husovsky@gmail.com', '192.168.1.1','23423445','23423424','0123456789/1234','true');
...
CASCADE NOT NULL,
   ...
   exportInterface                       int8,
   exportProtocolVersion                 int2,
   exportTransportProtocol               int2,
